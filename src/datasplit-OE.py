...
# Define the specific path for Open-Eyes
source_dir = 'data/Open-Eyes'
train_dir = 'data/Open-Eyes/train'
test_dir = 'data/Open-Eyes/test'
split_ratio = 0.9
...
def main():
    """Main function to execute the data splitting for Open-Eyes."""
    split_data(source_dir, train_dir, test_dir, split_ratio)
    print("Data split completed for Open-Eyes!")
